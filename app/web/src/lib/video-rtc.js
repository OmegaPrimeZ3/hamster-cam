 ...
 *
 * Vendored into hamster-cam so this module is bundled by Vite and served from
 * the same origin as the app (CSP: script-src 'self'). DO NOT load from a CDN.
 * To update: replace this file with a fresh copy from the upstream repo and
 * verify the VideoRTC class API has not changed before removing the adapter
 * in src/components/LiveStream.tsx.
 */
...
export class VideoRTC extends HTMLElement {
  ...
  oninit() {
    ...
    this.video.style.objectFit = 'inherit'; // let the wrapper control fit
...
// Guard prevents double-registration when HMR re-imports this module.
